...
# shamelessly copied from @martius-lab/comprl:comprl-hockey-game/render_game.py
# Modifications:
...
try:
    ...
    print("This script requires OpenCV. Please install it with:")
...
try:
    ...
    print("This script requires the imageio-ffmpeg plugin. Please install it with:")
    print("    pip install imageio-ffmpeg")
    sys.exit(1)

FONT_PATH = pathlib.Path(__file__).parent / 'fonts' / "f2-tecnocratica-ffp.ttf"
if not FONT_PATH.exists():
    print("This script requires the font file 'f2-tecnocratica-ffp.ttf'.")
    print("Download from https://www.dafont.com/f2-tecnocratica.font")
    print("  and place it in the fonts directory as this script.")
    sys.exit(1)
...
def main() -> int:
    ...
    parser.add_argument("--fps", type=float, default=25.0, help="Playback framerate.")
    parser.add_argument(
        "--save-video",
        type=pathlib.Path,
        metavar="dest",
