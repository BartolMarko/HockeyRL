...
class Episode(object):
	...
	def __init__(self, cfg, init_obs):
		...
		self.action = torch.empty((max_episode_length, cfg.action_dim), dtype=torch.long, device=self.device)
...
class ReplayBuffer():
	...
	def __init__(self, cfg):
		...
		self._action = torch.empty((self.capacity, cfg.action_dim), dtype=torch.long, device=self.device)
