...
MODEL_PATH = Path(__file__).resolve().parent / "results" / "baseline_sac" / "model_step_500038.pt"
GIF_SAVE_PATH = Path(__file__).resolve().parent / "results" / "baseline_sac" / "evaluation.gif"
